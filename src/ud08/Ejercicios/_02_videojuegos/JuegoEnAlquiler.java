...
public class JuegoEnAlquiler extends Juego{
    ...
    public JuegoEnAlquiler(String titulo, String fabricante, int anyo, int precio, int numCopias, int numDiasAlquilados) {
    ...
    public void alquilar() throws NoQuedanCopiasException{
        if (this.numCopias > 0) {
            this.numCopias--;
        } else {
