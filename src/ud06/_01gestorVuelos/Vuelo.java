...
public class Vuelo {
    ...
    public void cancelarReserva(int numAsiento) throws NumeroAsientoNoValidoException{
        if (numAsiento>this.asiento.length-1 || numAsiento<1) {
            throw new NumeroAsientoNoValidoException();
        }else{
            if (this.asiento[numAsiento]!=null) {
            this.asiento[numAsiento]=null;
            this.numP--;
            }else{
                System.out.println("Asiento introducio vacio \n");
            }
        }
    }

    static class NumeroAsientoNoValidoException extends Exception{
        public NumeroAsientoNoValidoException(){
            super("Numero de asiento introducido no valido.");
        }
    }
