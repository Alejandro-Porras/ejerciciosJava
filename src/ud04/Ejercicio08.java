...
public class Ejercicio08 {
    ...
    public static void main(String[] args) {
        ...
        //parte nueva del programa
        System.out.println("\n\n\nParte 2: ");
        System.out.println((posPrimero(v, 19)==-1?
        "No hay ningun dia con 19 litros diarios":
        "el primer día del mes en que llovió exactamente 19 litros es el dia " +
        posPrimero(v, 19)));
        
        System.out.println((posUltimo(v, 8)==-1?
        "No hay ningun dia con 19 litros diarios":
        "el último día del mes en que llovió exáctamente 8 litros es el dia " +
        posUltimo(v, 8)));
    }
}